...
const CommonChart = ({ id }: { id: string }) => {
    ...
    return (
        ...
        <div className="w-full">
                ...
                <div>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-500">Generated revenue for the selected period.</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
                <div>
                    <p className="text-sm font-medium text-gray-500">Total Generated Revenue</p>
            ...
            <div className="mt-7">
                ...
                {loading ? (
                    <div className="flex h-[380px] w-full flex-col items-center justify-center">
                    ...
                    <div className="flex h-[380px] w-full flex-col items-center justify-center rounded-3xl border border-dashed border-gray-200 bg-gray-50/60 px-6 text-center">
                        ...
                        <p className="mt-2 max-w-sm text-sm leading-6 text-gray-500">
                            No generated revenue was found for the selected{" "}
                            <span className="font-semibold text-gray-600">
                                {filter.toLowerCase()}
                            </span>{" "}period.</p>
                        <p className="mt-1 text-xs text-gray-400">Select another period to view available data.</p>
                    </div>
