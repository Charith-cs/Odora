...
import  {getAllSessions,getDoctorSessions,createSessionTemplate,updateSessionTemplate,cancelSession, getAllSessionTemplates} from "../controllers/session.controller";
...
router.get("/template/:id" ,verifyToken, getAllSessionTemplates); //update session
